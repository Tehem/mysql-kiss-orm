...
/**
 * Build the field list part of a query by joining elements
 *
 * Example:
 * [name, test, field]
 * => 'name,test,field'
...
/**
 * Build the WHERE part of a query with placeholders
 *
 * Example:
 * { name: 'test', address: '4 richard street', type: 3 }
 ...
 *
 * Example:
 * { name: 'test', address: '4 flower lane', type: 3 }
 * => { address: '4 flower lane', name: 'test', type: 3 }
 *
 ...
 *
 * Example:
 * [{ type: 2, name: 'test'}, {name: 'fake', type: 3}]
 * => ['test', 2, 'fake', 3]
 *
